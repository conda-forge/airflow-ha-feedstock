...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/airflow-ha-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/airflow-ha-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install airflow-ha
```
...
It is possible to list all of the versions of `airflow-ha` available on your platform:
...
```
pixi search airflow-ha --channel conda-forge
```
